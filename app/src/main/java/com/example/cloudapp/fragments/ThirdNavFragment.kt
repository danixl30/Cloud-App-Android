...
class ThirdNavFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_third_nav, container, false)
        root.findViewById<ImageButton>(R.id.cancelBtn).setOnClickListener {
            onClickButton.onClickButton("cancel")
        }
        root.findViewById<ImageButton>(R.id.pasteBtn).setOnClickListener {
            onClickButton.onClickButton("paste")
        }
        root.findViewById<ImageButton>(R.id.goUpClip).setOnClickListener {
